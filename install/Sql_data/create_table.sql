...
-- Dumping structure for table zhiphp_svn.zhi_ad
...
-- Dumping structure for table zhiphp_svn.zhi_adboard
...
-- Dumping structure for table zhiphp_svn.zhi_admin
...
-- Dumping structure for table zhiphp_svn.zhi_admin_auth
...
-- Dumping structure for table zhiphp_svn.zhi_admin_role
...
-- Dumping structure for table zhiphp_svn.zhi_article
...
-- Dumping structure for table zhiphp_svn.zhi_article_cate
...
-- Dumping structure for table zhiphp_svn.zhi_article_page
...
-- Dumping structure for table zhiphp_svn.zhi_article_re
...
-- Dumping structure for table zhiphp_svn.zhi_auto_user
...
-- Dumping structure for table zhiphp_svn.zhi_badword
...
-- Dumping structure for table zhiphp_svn.zhi_flink
...
-- Dumping structure for table zhiphp_svn.zhi_flink_cate
...
-- Dumping structure for table zhiphp_svn.zhi_ipban
...
-- Dumping structure for table zhiphp_svn.zhi_item_site
...
-- Dumping structure for table zhiphp_svn.zhi_jky_anhao
...
-- Dumping structure for table zhiphp_svn.zhi_jky_cate
...
-- Dumping structure for table zhiphp_svn.zhi_jky_cate_re
...
-- Dumping structure for table zhiphp_svn.zhi_jky_comment
CREATE TABLE IF NOT EXISTS `zhi_jky_comment` (
  ...
  `add_time` int(10) unsigned zerofill NOT NULL DEFAULT '0000000000',
...
-- Dumping structure for table zhiphp_svn.zhi_jky_icon
...
-- Dumping structure for table zhiphp_svn.zhi_jky_icon_type
...
-- Dumping structure for table zhiphp_svn.zhi_jky_item
CREATE TABLE IF NOT EXISTS `zhi_jky_item` (
  ...
  `img` varchar(255) DEFAULT NULL,
  `cate_id` int(10) NOT NULL DEFAULT '0',
  `orig_id` int(10) NOT NULL DEFAULT '0',
  ...
  `ordid` int(11) NOT NULL DEFAULT '255',
  `is_best` tinyint(1) NOT NULL DEFAULT '0',
  `is_hots` tinyint(1) NOT NULL DEFAULT '0',
  `is_duxiang` tinyint(1) NOT NULL DEFAULT '0',
...
-- Dumping structure for table zhiphp_svn.zhi_jky_orig
...
-- Dumping structure for table zhiphp_svn.zhi_mall
...
-- Dumping structure for table zhiphp_svn.zhi_mall_cate
...
-- Dumping structure for table zhiphp_svn.zhi_mall_comment
...
-- Dumping structure for table zhiphp_svn.zhi_menu
...
-- Dumping structure for table zhiphp_svn.zhi_message
...
-- Dumping structure for table zhiphp_svn.zhi_message_tpl
...
-- Dumping structure for table zhiphp_svn.zhi_nav
...
-- Dumping structure for table zhiphp_svn.zhi_oauth
...
-- Dumping structure for table zhiphp_svn.zhi_post
...
-- Dumping structure for table zhiphp_svn.zhi_post_baoliao
...
-- Dumping structure for table zhiphp_svn.zhi_post_cate
...
-- Dumping structure for table zhiphp_svn.zhi_post_cate_re
...
-- Dumping structure for table zhiphp_svn.zhi_post_comment
...
-- Dumping structure for table zhiphp_svn.zhi_post_favs
...
-- Dumping structure for table zhiphp_svn.zhi_post_rate
...
-- Dumping structure for table zhiphp_svn.zhi_post_tag
...
-- Dumping structure for table zhiphp_svn.zhi_score_item
...
-- Dumping structure for table zhiphp_svn.zhi_score_item_cate
...
-- Dumping structure for table zhiphp_svn.zhi_score_log
...
-- Dumping structure for table zhiphp_svn.zhi_score_order
...
-- Dumping structure for table zhiphp_svn.zhi_setting
...
-- Dumping structure for table zhiphp_svn.zhi_tag
...
-- Dumping structure for table zhiphp_svn.zhi_user
...
-- Dumping structure for table zhiphp_svn.zhi_user_address
...
-- Dumping structure for table zhiphp_svn.zhi_user_bind
...
-- Dumping structure for table zhiphp_svn.zhi_user_stat
